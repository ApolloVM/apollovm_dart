...
/// JavaScript (modern ES) grammar lexer: keywords, numbers, string literals
/// (single/double quoted + back-tick template literals with `${...}`
/// interpolation), whitespace and comments.
abstract class JavaScriptGrammarLexer extends BaseGrammarLexer {
  // -----------------------------------------------------------------
  // Keyword definitions.
  // -----------------------------------------------------------------
...
extension TrimHiddenStuffWhitespaceParserExtensionJS<R> on Parser<R> {
  Parser<R> trimHidden() =>
      trim(JavaScriptGrammarLexer.hiddenStuffWhitespaceStatic());
}
